...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || '519f0a0870a0428bb99273a6aa55fce0',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://mwwlzz.top', // 网站地址
  ...
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/Eoza1', // 你的telegram 地址 例如 https://t.me/tangly_1024
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'huhu BLOG', // 站点标题 ，被notion中的页面标题覆盖
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || './bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Just enjoy it', // 站点描述，被notion中的页面描述覆盖
